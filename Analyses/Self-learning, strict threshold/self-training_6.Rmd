...
Loading the data
```{r}
covid <- readRDS("D:/Data/Training samples/misinformation_class_5.RDS")
...
cm_svm$byClass["F1"] # 0.8938547    
cm_svm$byClass["Precision"] # 0.9160305   
cm_svm$byClass["Recall"] # 0.8727273   
```
...
```{r}
saveRDS(covid_predicted, "D:/Data/Training samples/misinformation_class_6.RDS")
```
