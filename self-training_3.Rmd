...
```{r}
21971/(table(train$label)[1] * 2)
21971/(table(train$label)[2] * 2)
```

```{r}
train <- train |>
  mutate(case_wts = ifelse(label == "misinfo", 4.932869, 0.5563969),
...
cm_lr$byClass["F1"] # 0.9707823 
cm_lr$byClass["Precision"] # 0.9961315 
cm_lr$byClass["Recall"] # 0.9466912 
```
