...
```{r}
896/(table(train$label)[1] * 2)
896/(table(train$label)[2] * 2)
```

```{r}
train <- train |>
  mutate(case_wts = ifelse(label == "misinfo", 5.530864 , 0.5496933 ),
...
cm_lr$byClass["F1"] # 0.2580645  
cm_lr$byClass["Precision"] # 0.5333333  
cm_lr$byClass["Recall"] # 0.1702128  
```
