...
Loading the data
```{r}
covid <- readRDS("D:/Data/Training samples/misinformation_class_3.RDS")
...
cm_svm$byClass["F1"] # 0.859335  
cm_svm$byClass["Precision"] # 0.8682171  
cm_svm$byClass["Recall"] # 0.8506329  
```
...
cm_svm <- confusionMatrix(table(new_test$label, model_svm$...202)) 
cm_svm$byClass["F1"] # 0.8508997  
cm_svm$byClass["Precision"] # 0.8552972  
cm_svm$byClass["Recall"] # 0.8465473 
```
...
```{r}
saveRDS(covid_predicted, "D:/Data/Training samples/misinformation_class_4.RDS")
```
