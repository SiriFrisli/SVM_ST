...
cm_svm$byClass["F1"] # 0.7821229   
cm_svm$byClass["Precision"] # 0.7984791   
cm_svm$byClass["Recall"] # 0.7664234   
```
...
cm_svm <- confusionMatrix(table(new_test$label, model_svm$...202)) 
cm_svm$byClass["F1"] # 0.7721281  
cm_svm$byClass["Precision"] # 0.7794677  
cm_svm$byClass["Recall"] # 0.7649254  
```
