...
cm_svm$byClass["F1"] # 0.5384615    
cm_svm$byClass["Precision"] # 0.4666667  
cm_svm$byClass["Recall"] # 0.6363636 
```
...
new_test |>
  ...
  autoplot(type = "heatmap") # 8 FN, 4 FP
```
...
cm_lr$byClass["F1"] # 0.3829787  
cm_lr$byClass["Precision"] # 0.6  
cm_lr$byClass["Recall"] # 0.28125  
```
