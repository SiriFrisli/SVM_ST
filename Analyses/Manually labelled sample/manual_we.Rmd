...
cm_svm <- confusionMatrix(table(new_test$label, model_svm$...302), positive = "misinfo") 
...
cm_lr$byClass["F1"] # 0.2739726  
cm_lr$byClass["Precision"] # 0.6666667  
cm_lr$byClass["Recall"] # 0.1724138  
```
...
cm_bt$byClass["F1"] # 0.2857143 
cm_bt$byClass["Precision"] # 0.6
